...
namespace SevenStarAutoSell.Bet.Common
{
    ...
    public class MQThreads : Singleton<MQThreads>
    {
        ...
        /// 服务器推送下注事件
        /// </summary>
        public event BetContentEventHandler PushBetEvent;

        /// <summary>
        /// 退单事件
        /// </summary>
        public event DeleteBetContentEventHandler DeleteBetEvent;
    ...
    public delegate void BetContentEventHandler(BetContent content);

    /// <summary>
    /// 下注信息
    /// </summary>
    /// <param name="content">退单内容</param>
    public delegate void DeleteBetContentEventHandler(BetContentResult content);
